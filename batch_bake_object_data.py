...
class AOV_Diffuse(PropertyGroup):
...
class AOV_Glossy(PropertyGroup):
...
class AOV_Transmission(PropertyGroup):
...
class AOV_Subsurface(PropertyGroup):
...
class AOV_Normal(PropertyGroup):
    normal = BoolProperty(
        name='Normal',
        default=False,
        )
...
class AOV_Combined(PropertyGroup):
...
class AOV_Shadow(PropertyGroup):
    shadow = BoolProperty(
        name='Shadow',
        default=False,
        )
...
class AOV_Environment(PropertyGroup):
    env = BoolProperty(
        name='Environment',
        default=False,
        )
